...
$$C(z) = T\left\{ \frac{z}{2z - 1} + \frac{4z}{4z - 1}\right\}$$
### Ventajas
...
$$C(z) = \frac{z-1}{z}Z\left \{\mathcal{L}^{-1} \left\{C(s) \frac{1}{s} \right\}\right\}$$
### 💡 Ejemplo 2
...
**Transformada inversa de Laplace:**
$$\mathcal{L}^{-1}\left\{\frac{C(s)}{s}\right\} = \frac{1}{6} - \frac{1}{2}e^{-t} + \frac{1}{2}e^{-2t} - \frac{1}{6}e^{-3t}$$
**Resolviendo por tablas:**
$$Z\left\{\mathcal{L}^{-1}\left\{\frac{C(s)}{s}\right\}\right \}=\frac{1}{6} \cdot \frac{z}{z-1} - \frac{1}{2} \cdot \frac{z}{z - e^{-1}} + \frac{1}{2} \cdot \frac{z}{z - e^{-2}} - \frac{1}{6} \cdot \frac{z}{z - e^{-3}}$$
**Por definición:**
$$C(z)=\frac{z-1}{z}\left(\frac{1}{6} \cdot \frac{z}{z-1} - \frac{1}{2} \cdot \frac{z}{z - e^{-1}} + \frac{1}{2} \cdot \frac{z}{z - e^{-2}} - \frac{1}{6} \cdot \frac{z}{z - e^{-3}}\right)$$
...
$$\mathcal{L}\left\{ \frac{d}{dx}x(t)\right\}=sX(s)$$
...
**Al aplicar la transformada Z se obtiene:**
$$Z\left\{\frac{x(k)-x(k-1)}{T}\right\}=\frac{X(z)-z^{-1}X(z)}{T}=\frac{1-z^{-1}}{T}X(z)$$
**Sabiendo la transformada de Laplace de una derivada:**
$$\mathcal{L}\left\{ \frac{d}{dx}x(t)\right\}=sX(s)$$
**Se pueden aproximar las dos transformadas:**
...
$$ G(s) = \frac{s + 3}{s^2 + 4s + 5} \approx \frac{\frac{z-1}{z} + 3}{\left(\frac{z-1}{z}\right)^2 + 4\left(\frac{z-1}{z}\right) + 5} $$
